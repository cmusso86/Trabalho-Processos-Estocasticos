...
de uma transição ter distribuição constante.
...
em cada tover distribuição constante, o processo semi-Markov se torna
...
Os parâmetros do modelo foram estimados a partir da prevalência da
doença na população
